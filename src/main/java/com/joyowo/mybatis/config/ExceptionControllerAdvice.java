...
public class ExceptionControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleInvalidRequest(Exception e, WebRequest request) {
        ...
        if (e instanceof NullPointerException) {
            ...
            RuntimeException apiException = (RuntimeException) e;
            String errmsg = "";
        ...
        ResponseEntity<Object> r = handleExceptionInternal(e, error, headers, HttpStatus.INTERNAL_SERVER_ERROR, request);
        return r;
    }
